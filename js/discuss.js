var Discuss = {
  ...
  deleteForum: function(id) {
    showConfirmBox('Удаление форума', 'Вы уверене, что хотите удалить данный форум? Данное действие удалит все темы и сообщения, его нельзя будет отменить', 'Да', function() {
