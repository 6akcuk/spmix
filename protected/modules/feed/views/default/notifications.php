...
$this->pageTitle = Yii::app()->name .' - Ответы';
$delta = Yii::app()->controller->module->newsPerPage;
?>
<div class="tabs">
  <?php echo ActiveHtml::link('Новости', '/feed') ?>
  <?php echo ActiveHtml::link('Ответы'. (($this->pageCounters['news'] > 0) ? ' <b>+'. $this->pageCounters['news'] .'</b>' : ''), '/feed?section=notifications', array('class' => 'selected')) ?>
