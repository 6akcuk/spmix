...
/**
 * This is the model class for table "purchase_external".
 *
 * The followings are the available columns in table 'purchase_external':
 * @property integer $purchase_id
 * @property string $shortstory
 * @property string $fullstory
 */
class PurchaseExternal extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PurchaseExternal the static model class
	 */
