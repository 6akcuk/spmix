...
<div class="wishlist_wrap clearfix">
  <div class="wishlist_want_wrap left">
    ...
    <? if (0 + Yii::app()->getModule('wishlist')->wishesPerPage < $wantsNum && $wantsNum > Yii::app()->getModule('wishlist')->wishesPerPage): ?><a class="pg_more" onclick="Wishlist.showMore(1)">Показать еще</a><? endif; ?>
  </div>
  <div class="wishlist_can_wrap left">
    ...
    <? if (0 + Yii::app()->getModule('wishlist')->wishesPerPage < $cansNum && $cansNum > Yii::app()->getModule('wishlist')->wishesPerPage): ?><a class="pg_more" onclick="Wishlist.showMore(2)">Показать еще</a><? endif; ?>
  </div>
</div>