...
?>
  <div class="tabs">
    ...
    <?php echo ActiveHtml::link('Мой пристрой', '/market?act=my', array('class' => 'selected')) ?>
    <div class="right">
  ...
  <div class="market_search_categories clearfix">
    <?php foreach ($categories as $category): ?>
      <a onclick="return nav.go(this, event)" class="left<?php echo (isset($c['category_id']) && $c['category_id'] == $category->category_id) ? ' selected' : '' ?>" href="/market?act=my&c[q]=<?php echo (isset($c['q'])) ? $c['q'] : '' ?>&c[category_id]=<?php echo $category->category_id ?>"><?php echo $category->name ?></a>
    <?php endforeach; ?>
  </div>
