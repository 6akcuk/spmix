 ...
 *
 * The followings are the available columns in table 'rbac_item_childs':
 ...
 */
class RbacItemChild extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RbacItemChild the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'parent0' => array(self::BELONGS_TO, 'RbacItems', 'parent'),
			'child0' => array(self::BELONGS_TO, 'RbacItems', 'child'),
		);
	}
