 ...
 * @property RbacItems $itemname0
 */
class RbacAssignment extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RbacAssignment the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'itemname0' => array(self::BELONGS_TO, 'RbacItems', 'itemname'),
		);
	}
